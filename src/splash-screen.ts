...
export const displaySplashScreen = async (): Promise<void> => {
  try {
    ...
    // Create the main VARUNAX ASCII art
    const varunaxText = figlet.textSync('VARUNAX', {
      font: 'ANSI Shadow',
      horizontalLayout: 'default',
      verticalLayout: 'default',
    });

    // Apply light green gradient to VARUNAX
    const gradientVarunaX = gradient(['#90EE90', '#98FB98'])(varunaxText);
    ...
    console.log(chalk.cyan.bold('\n🚀 VARUNAX - AI Penetration Testing Framework\n'));
