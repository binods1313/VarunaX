...
Code Pointers:
- Handler: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:10-20
- Form: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/forms.py:4-8
- Template: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/templates/accounts/register_step1.html
```
...
Code Pointers:
- Handler: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:22-33
- Form: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/forms.py:9-11
...
Code Pointers:
- Handler: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:35-61
- SSTI Vulnerability: views.py:56-58
- Flag Exposure: views.py:39, 51, 61
- Premium Self-Assignment: views.py:43-48
- Form: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/forms.py:12-14
```
...
Code Pointers:
- Handler: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:64-76
...
Code Pointers:
- Handler: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:102-104
```
...
- **Code Location:** /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:43-48
...
- **Location:** /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/models.py:6
...
**Code Pointers:**
- Model Definition: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/models.py:5-9
- Display Only: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/templates/accounts/preferences.html:38-41
...
|--------|---------------|---------------|----------------------|------------------------|---------------------------|
| GET, POST | / | anon | None | None | Public gallery view displaying 9 hardcoded art items with prices. Template conditionally displays "Welcome, {user.name}" if authenticated. See `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:85-100` |
| GET, POST | /accounts/register/step1/ | anon | None | None | Registration step 1 - collects name and password. CRITICAL: Stores plaintext password in session (line 15). Entry point for SSTI vulnerability chain. See `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:10-20` |
| GET, POST | /accounts/register/step2/ | anon (session check) | None | Session state validation (bypassable) | Registration step 2 - collects email address. Validates session contains 'name' and 'password' from step 1. Session check at line 23-24 only verifies key existence, not integrity. See `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:22-33` |
| GET, POST | /accounts/register/step3/ | anon (session check) | None | Session state validation (bypassable) | CRITICAL VULNERABILITY: SSTI at lines 56-58 allows template injection via session['name']. Reads flag file (line 39), exposes flag in template context (line 61). Allows self-service premium assignment (line 43-48). See `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:35-61` |
| GET, POST | /accounts/login/ | anon | None | None | User authentication endpoint using Django's AuthenticationForm. No rate limiting, no CAPTCHA, no account lockout. Uses email as username field. See `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:64-76` |
| GET, POST | /accounts/home/ | anon | None | None | Simple redirect to / (gallery view). Configured as LOGIN_REDIRECT_URL but accessible without authentication. See `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:78-79` |
| GET, POST | /accounts/preferences/ | **user** | None | Bearer Token + `@login_required` decorator | User settings page - ONLY endpoint requiring authentication. Displays user.username, user.email, and user.is_premium status (display only, no enforcement). See `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:81-83` |
| GET, POST | /accounts/logout/ | anon | None | None | Logout endpoint using Django's logout() function. Destroys session and redirects to /. Accessible to non-authenticated users (harmless but inelegant). See `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:102-104` |
...
- URL Routing: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/art_gallery/urls.py
- Application URLs: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/urls.py
- Middleware: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/art_gallery/settings.py:32-40
...
- **name** (CharField)
  ...
  - Location: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/forms.py:6
...
- **password** (CharField)
  ...
  - Location: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/forms.py:7
...
- **email** (EmailField)
  ...
  - Location: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/forms.py:10
...
- **is_premium** (BooleanField)
  ...
  - Location: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/forms.py:13
...
- Model: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/models.py:5-9
...
**Code References:**
- Only Authorization Check: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:81 (`@login_required`)
- Premium Assignment (No Validation): /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:43-48
- Premium Display (Template Only): /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/templates/accounts/preferences.html:38-41
- Authentication Middleware: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/art_gallery/settings.py:35
...
Code Location: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:58
...
POST /accounts/register/step1/
  ...
  File: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:14

Step 2: Email Collection (session persists)
POST /accounts/register/step2/
  Session validation checks 'name' exists
  → request.session['email'] = form.cleaned_data['email']
  File: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:29
...
GET/POST /accounts/register/step3/
  ...
  File: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:56-61
```
...
**File Path:**
- Vulnerability: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/views.py:56-58
- Input Source: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/forms.py:6 (name field)
- Template: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-025-24/app/art_gallery/accounts/templates/accounts/register_step3.html:37
