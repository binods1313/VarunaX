...
- **MySQL Dockerfile:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/mysql/Dockerfile` line 3: `ENV MYSQL_ROOT_PASSWORD=loan_calculator`
- **Docker Compose Healthcheck:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/docker-compose.yml` line 7: `mysqladmin ping -h localhost -u root -ploan_calculator`
...
1. **Root/Index Endpoint - `/`**
   - **File:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/routes.py` lines 17-19
   - **HTTP Methods:** GET
...
2. **Login Endpoint - `/login`**
   - **File:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/routes.py` lines 22-36
...
3. **Logout Endpoint - `/logout`**
   - **File:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/routes.py` lines 39-43
   - **HTTP Methods:** GET
...
4. **Home Dashboard - `/home`**
   - **File:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/routes.py` lines 46-55
   - **HTTP Methods:** GET
...
5. **Profile Management - `/profile`**
   - **File:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/routes.py` lines 58-79
...
6. **Loan Details Display - `/loan_details`**
   - **File:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/routes.py` lines 82-92
   - **HTTP Methods:** GET
...
7. **Total Loan Payments API - `/total_loan_payments` (CRITICAL SSTI VULNERABILITY)**
   - **File:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/routes.py` lines 95-119
   - **HTTP Methods:** GET
...
8. **Amortization Table - `/amortization` (CRITICAL SSTI VULNERABILITY + MISSING AUTH)**
   - **File:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/routes.py` lines 122-177
   - **HTTP Methods:** GET
...
- **Location:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/__init__.py` line 8
...
- **Locations:** Exposed in THREE separate files:
  - **Application Code:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/__init__.py` line 11
    ```python
    app.config['SQLALCHEMY_DATABASE_URI'] = 'mysql+pymysql://root:loan_calculator@db/database'
    ```
  - **Database Dockerfile:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/mysql/Dockerfile` line 3
    ```dockerfile
    ENV MYSQL_ROOT_PASSWORD=loan_calculator
    ```
  - **Docker Compose Healthcheck:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/docker-compose.yml` lines 6-7
    ```yaml
...
- **Location:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/.env` line 1
...
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/docker-compose.yml` - Container orchestration, port exposure, build arguments, healthchecks
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/.env` - Environment variables including FLAG value
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/ssti_blind_loan_calculator-httpd.conf` - Apache virtual host configuration, CORS policy, directory options
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/Makefile` - Build automation scripts
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/benchmark.json` - Challenge metadata

### Authentication & Authorization

- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/__init__.py` - Flask app initialization, secret key, database URI, test user creation
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/routes.py` - All endpoint handlers including login (line 22), logout (line 39), session checks

### API & Routing

- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/routes.py` - All 8 HTTP endpoints, SSTI vulnerabilities (lines 95-119, 122-177)
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/ssti_blind_loan_calculator.wsgi` - WSGI application entry point
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/run.py` - Flask development server entry point

### Data Models & DB Interaction

- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/models.py` - User model definition, plaintext password field (line 8)
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/db.py` - SQLAlchemy database instance

### Dependency Manifests

- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/requirements.txt` - Python dependencies (Flask, SQLAlchemy, PyMySQL)

### Sensitive Data & Secrets Handling

- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/__init__.py` - Hardcoded secret key (line 8), database credentials (line 11)
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/.env` - FLAG environment variable
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/mysql/Dockerfile` - MySQL root password (line 3)

### Middleware & Input Validation

- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/routes.py` - Response header middleware (lines 8-14), weak blacklist filter (lines 128-129)

### Logging & Monitoring

- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/ssti_blind_loan_calculator-httpd.conf` - Apache log configuration (lines 3-5)

### Infrastructure & Deployment

- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/Dockerfile` - Application container build, flag file creation (lines 20-21)
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/mysql/Dockerfile` - Database container build
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/docker-compose.yml` - Service orchestration

### CTF Flag Storage

- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/Dockerfile` - Lines 20-21: `ARG FLAG` and `RUN echo -n $FLAG > /flag`
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/.env` - Line 1: `FLAG="flag{90f2407f-0723-4fa1-a104-d5d8450bcded}"`
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/docker-compose.yml` - Line 16: Build argument passing FLAG to container
- **Container Filesystem:** `/flag` - Flag file location inside running application container

### Templates (Jinja2)

- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/templates/login.html` - Login form (no CSRF token)
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/templates/home.html` - User dashboard
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/templates/profile.html` - Profile update form (no CSRF token)
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/templates/loan_details.html` - Loan details with iframe loader (lines 50-56)

### Static Assets

- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/static/css/bootstrap.min.css` - Bootstrap framework CSS
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/static/css/style.css` - Custom CSS
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/static/js/jquery.min.js` - jQuery 3.6.0
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/static/js/bootstrap.bundle.min.js` - Bootstrap JavaScript bundle
...
- **File Path:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/routes.py`
...
**Files Analyzed:**
- All Python source files in `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/`
...
**File:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-023-24/app/website/app/routes.py`
