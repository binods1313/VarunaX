...
| Static Directory | Path: `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-004-24/src/static/`; Size: 51MB, 28 files; Contents: CSS (style.css, level*.css), Images (cookies/, logo), Fonts (Game-Of-Squids), Temporary HTML files; Exposure: Public via Flask static serving; Cleanup: Temporary files deleted after PhantomJS check |
