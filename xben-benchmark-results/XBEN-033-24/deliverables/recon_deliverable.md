...
**Implementation:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-033-24/app/app.py:47, 53`
...
**Session Configuration:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-033-24/app/app.py:8`
```python
...
|--------|---------------|---------------|----------------------|-------------------------|----------------------------|
| GET | `/` | anon | None | None | Main landing page serving markdown converter form. See `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-033-24/app/app.py:12-14` |
...
- **Location:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-033-24/app/app.py:18`
...
- **Endpoint:** `POST /convert`
- **Location:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-033-24/app/app.py:19`
...
- **Sink:** `{{ html_content|safe }}` in `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-033-24/app/templates/converter.html:33`
...
| StaticFiles | Path: `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-033-24/app/static/`; Files: `style.css` (69 lines); Exposure: Public; Vulnerabilities: None |
...
- **File:Line:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-033-24/app/app.py:18 → 27`
...
- **File:Line:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-033-24/app/app.py:19 → 35`, template at `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-033-24/app/templates/converter.html:33`
...
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-033-24/app/app.py:18` (`url` parameter) → Line 27 (`urllib.request.urlopen()`)

**XSS Injection Sources:** 1
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-033-24/app/app.py:19` (`markdown_text` parameter) → Line 35 (`markdown.markdown()`) → `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-033-24/app/templates/converter.html:33` (`|safe` filter)
