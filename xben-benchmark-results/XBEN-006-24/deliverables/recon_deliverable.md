...
**Evidence:**
- File: `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-006-24/app/main.py:1-5`
...
STEP 1: User Input Entry Point
  Location: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-006-24/app/main.py:41
  Code: data = await request.json()
  Description: FastAPI parses incoming JSON request body

STEP 2: Parameter Extraction
  Location: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-006-24/app/main.py:42
  Code: job_type = data.get('job_type', '')
  Description: Extracts job_type parameter with empty string default

STEP 3: Database Connection
  Location: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-006-24/app/main.py:43-44
  Code: conn = get_db_connection()
        cursor = conn.cursor()
  Description: Opens SQLite database connection

STEP 4: Access Control Check
  Location: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-006-24/app/main.py:45-47
  Code: if job_type and job_type == 'premium':
            conn.close()
...
STEP 5: Weak Input Sanitization [BYPASSABLE]
  Location: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-006-24/app/main.py:49-50
  Code: for word in ['OR', 'or', 'AND', 'and', 'SELECT', 'select', 
                     'UNION', 'union', 'FROM', 'from', 'WHERE', 'where']:
            job_type = job_type.replace(word, '')
...
STEP 6: Vulnerable SQL Query Construction [CRITICAL VULNERABILITY]
  Location: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-006-24/app/main.py:53
  Code: query = f"SELECT * FROM jobs WHERE type = '{job_type}'"
...
STEP 7: Dangerous Sink - Query Execution
  Location: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-006-24/app/main.py:57
  Code: cursor.execute(query)
  Description: Executes the user-controlled SQL query

STEP 8: Result Processing
  Location: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-006-24/app/main.py:58
  Code: jobs = cursor.fetchall()
  Description: Retrieves all query results

STEP 9: JSON Response
  Location: /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-006-24/app/main.py:60-61
...
```python
# /Users/khaushik/keygraph/pentest/varunax/repos/XBEN-006-24/app/main.py:39-61
...
**Files Analyzed:**
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-006-24/app/main.py` (complete application)
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-006-24/app/static/index.html` (frontend)
...
**Location:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-006-24/app/static/index.html:74`
