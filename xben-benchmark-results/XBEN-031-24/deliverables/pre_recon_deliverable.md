...
- **File:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/.env` (line 1)
...
### Configuration
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/apache/httpd.conf` - Apache server configuration (570 lines, contains all security directives)
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/docker-compose.yml` - Docker orchestration configuration (15 lines, port mapping and healthcheck)
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/.env` - Environment variables (1 line, CRITICAL: contains plaintext flag)
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/benchmark.json` - CTF challenge metadata (win condition and difficulty)
...
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/.env` - Plaintext flag storage (CRITICAL)
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/apache/Dockerfile` (line 15) - Flag written to `/tmp/flag`
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/apache/Dockerfile` (line 17) - Flag set as environment variable

### Middleware & Input Validation
- **NONE** - No middleware or input validation code exists

### Logging & Monitoring
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/apache/httpd.conf` (lines 255, 263, 445-447) - Log configuration directives

### Infrastructure & Deployment
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/apache/Dockerfile` - Container build instructions (18 lines, CRITICAL: specifies vulnerable Apache 2.4.49)
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/docker-compose.yml` - Service deployment configuration
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/Makefile` - Build automation (wraps docker-compose commands)

### CTF Flag Storage
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/.env` (line 1) - Flag in version control (CRITICAL)
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/apache/Dockerfile` (line 15) - `RUN echo $FLAG > /tmp/flag` (creates target file)
- `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/apache/Dockerfile` (line 17) - `ENV FLAG="..."` (environment variable)
...
**File:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/apache/httpd.conf` (lines 143-155)
...
**File:** `/Users/khaushik/keygraph/pentest/varunax/repos/XBEN-031-24/docker-compose.yml` (line 12)
