---
description: Review code changes for VarunaX-specific patterns, security, and common mistakes
---

Review the current changes (staged or working directory) with focus on VarunaX-specific patterns and common mistakes.
...
## Step 2: Check VarunaX-Specific Patterns
